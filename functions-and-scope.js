...
let studentsWithCumLaudeGrades = 0;

for (let i = 0; i < grades.length; i++) {
    if (grades[i] >= 8) {
        studentsWithCumLaudeGrades++;
    }
}
console.log(studentsWithCumLaudeGrades);
...
for (let i = 0; i < grades.length; i++) {
    if (grades[i] >= 8) {
        studentsWithCumLaudeGrades = studentsWithCumLaudeGrades + 1;
    }
}
console.log(studentsWithCumLaudeGrades);*/
...
const passedStudents = cumLaude([8, 9, 4, 6, 10]);
